...
- STILL TO DO: Phase I audit (optional given time), Phase J README (readme-craft) + docs/hackathon/EVIDENCE.md, Phase K submit (Google Form + Discord). Deadline July 7 16:59 PDT.
